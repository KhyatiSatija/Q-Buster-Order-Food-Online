    ...
    <div className='footer'>
      <div className='footerin1'>
        <div className='f1'>
          ...
          <p>One Stop Destination. 
Beat the Queue: Get a wait time & unique token - track your order live & plan your time</p>
      ...
      <div className='footerin2'>
        <h3>© Copyright 2024 Q-Buster, Inc.  All rights reserved</h3>
